...
module.exports = {
    ...
    onStart: async function ({ api, event, args }) {
        ...
        if (!args[0] || tzt.length !== 2) {
            return api.sendMessage("Please provide two names separated by a line |", event.threadID, event.messageID);
        }
...
const loveCalculator = {
    ...
    getLoveComment: async (percentage) => {
        if (percentage < 10) {
            ...
            return {
                comment: "If you two keep loving each other or confess your feelings, it might make some good changes 👩‍❤️‍💋‍👨",
            ...
            return {
                comment: "Amazing perfectly matched! You two are meant to be for each other. Best wishes for your future! 👩‍❤️‍💋‍👨💐",
